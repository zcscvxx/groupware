...
<body>
	...
	<table class="mailbox">
		...
		<tr>
			...
			<td colspan="2"><input class="textcol" type="text" size="20" name="sender" value="${member_id}" readonly></td>
		</tr>
		<tr>
			<td></td><td></td><td >받을사람</td><td><input class="textcol1" type="text"  name="reciever" value="" required></td>
			<td>
		...
		<tr>
			<td></td><td></td><td colspan=3><textarea class="textcol2" rows="10" cols="25" name="content" ></textarea>
		</tr>
	</table>
	</form>
</body>
