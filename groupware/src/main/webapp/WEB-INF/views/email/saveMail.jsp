...
<script type="text/javascript">
	function page(idx){
		var pagenum = idx;
		var contentnum = 15;
		location.href="${pageContext.request.contextPath}/saveMail?pagenum="+pagenum+"&contentnum="+contentnum;
	}
	function sndata(){
		var cnt = 0;
		...
		location.href="moveTrashSaveMole?check="+arraycheck+"&cnt="+cnt;
	}
	function sndata3(){
		var cnt = 0;
		var arraycheck = new Array();
		...
		location.href="recoverMailSaveMole?check="+arraycheck+"&cnt="+cnt;
	}
	function allch(){
...
<body>
	...
	<table class="mailbox">
		...
		<c:forEach items="${listSaveMail}" var="dto">
		<tr>
			...
			<td>
				<a href="readMailSave?mail_num=${dto.mail_num}">${dto.mail_title}</a></td>
