...
%>
	<table class="readmail">
		...
		<tr>
			<td></td><td></td>
			<td colspan=2 align=center><a href="moveTrashSave?mail_num=${listMail.mail_num}&member_id=${listMail.member_id}&mail_rcvmember=${listMail.mail_rcvmember}">휴지통</a></td>
			<td colspan=2 align=center><a href="recoverMailSave?mail_num=${listMail.mail_num}&member_id=${listMail.member_id}&mail_rcvmember=${listMail.mail_rcvmember}">복원</a></td>
		</tr>
	</table>
</body>
</html>