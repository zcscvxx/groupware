...
%>
	<table class="readmail">
		...
		<tr>
			<td></td><td></td>
			<td colspan=2 align=center><a href="moveTrashSend?mail_num=${listMail.mail_num}">휴지통</a></td>
			<td colspan=2 align=center><a href="moveSaveSend?mail_num=${listMail.mail_num}">저장</a></td>
		</tr>
	</table>
</body>
</html>