...
<body>
<form id="Member" name="Member" action="Member" method="post">
<%
...
<div class="div1">
<div class="div2">
<dt class="clause1">회원가입 약관</dt><br>
<textarea name="clausearea1" cols="50" rows="8">
제 1 장 총 칙

 

제 1 조 (목적)
이 약관은 비젼컴퍼니(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
...
<dt class="clause2">개인정보취급방침</dt><br>
<textarea name="clausearea2" cols="50" rows="8">
...
<div><center><input class="btnsub" type="submit" value="다음으로"></center></div>
</div>
